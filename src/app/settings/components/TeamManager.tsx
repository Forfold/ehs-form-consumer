      ...
      prev.map((t) =>
        t.id === teamId
          ? {
              ...t,
              members: [
                ...t.members.filter((m) => m.userId !== member.userId),
                member,
              ],
            }
          : t,
  ...
  return (
    <Container maxWidth="md" sx={{ py: 4, flex: 1 }}>
      ...
      <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
        Create teams to share form submissions with colleagues. Any team member can
        share their own submissions; owners and admins manage membership.
      </Typography>
